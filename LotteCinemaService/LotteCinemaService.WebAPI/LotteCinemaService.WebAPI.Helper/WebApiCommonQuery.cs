...
namespace LotteCinemaService.WebAPI.Helper
{
    public static class WebApiCommonQuery
    {
        ...
        public static string GetAdInfoList_test(string theater, int itemID, bool isSpecial)
        {
        ...
        public static string GetMovieTimeCellInfoList_New(string theater1, string theater2)
        {
            return string.Format("Common/MovieTimeCellInfoList_New?theater1={0}&theater2={1}", theater1, theater2);
        }
        ...
        public static string Insert_FileSync(AdInfoRaw ad)
        {
            return string.Format("Common/SetTransparentAdverInfo?ad={0}", ad);
        }
        ...
        public static string InsertSpecialType(bool status)
        {
            return string.Format("TMB/SetSpecialType?status={0}", status);
        }

        public static string GetSpecialType()
        {
            return string.Format("TMB/SpecialType?theater=1016");
        }
        ...
        public static string InsertMovieContentsAvailable(MovieContentsInfoRaw mItem)
        {
            return string.Format("Common/InsertMovieContentsAvailable?mItem={0}", mItem);
        }
        ...
        public static string DeleteMovieContentsAvailable(string id)
        {
            return string.Format("Common/DeleteMovieContentsAvailable?id={0}", id);
        }
        ...
        {
            return string.Format("Common/MovieContentsUploadAvailableInfoList?startDate={0}&endDate={1}&searchTitle={2}",startDate.ToShortDateString(), endDate.ToShortDateString(), searchTitle);
        }
