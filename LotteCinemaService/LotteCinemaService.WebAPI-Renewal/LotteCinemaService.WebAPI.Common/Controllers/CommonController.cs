    ...
    public class CommonController : ApiController
    {
        ...
        public List<MovieTimeCellInfo> GetMovieTimeCellInfoList(string theater1, string theater2)
        {
            ...
            foreach (var movieCell in movieCellList)
            {
                ...
                movieCell.ScreenCode = movieCell.ScreenNumber.ToString("00");
        ...
        {
            return this._cmManager.GetRecommandMovieInfoList(itemID);
        }
        #endregion
        ...
        public List<RecommandedMovieInfo> GetRecommandedMovieInfoList(string theater, string itemID)
        {
            ...
            var result = this._cmManager.GetRecommandedMovieInfoList(itemID);
        ...
        #region GetMovieContentsUploadAvailableInfoList
        [HttpGet]
        [GET("Common/MovieContentsUploadAvailableInfoList?{startDate}&{endDate}&{searchTitle}")]
        ...
        {
            return this._cmManager.GetMovieContentsUploadAvailableInfoList(startDate,endDate,searchTitle);
        }
        #endregion
        ...
        public void SetAdverInfo(AdInfoRaw ad)
        {
           ...
           [HttpPut]
        [PUT("Common/InsertMovieContentsAvailable?{mItem}")]
        public void InsertMovieContentsAvailable(MovieContentsInfoRaw mItem)
        {
            if (!this._cmManager.InsertMovieContentsAvailable(mItem))
            {
                ResponseException();
            }
        }
        ...
        [HttpDelete]
        [DELETE("Common/DeleteMovieContentsAvailable?{id}")]
        public void DeleteMovieContentsAvailable(int id)
        {
            if (!this._cmManager.DeleteMovieContentsAvailable(id))
            {
                ResponseException();
            }
        }
