...
namespace FTP
{
    ...
    public class FtpDownloadDirectoryChangedEventArgs
    {
        ...
        public FtpDownloadDirectoryChangedEventArgs(int totalFileCount, int fileCount, string fileName, string localPath, string ftpPath, long totalFileSize, long fileSize)
        {
